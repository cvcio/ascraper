...
var _require = require('cheerio'),
  load = _require.load;
var _require2 = require('@mozilla/readability'),
  Readability = _require2.Readability;
var _require3 = require('jsdom'),
  JSDOM = _require3.JSDOM;
var _require4 = require('url'),
  URL = _require4.URL;
var _require5 = require('./utils'),
  fetchAPI = _require5.fetchAPI,
  sanitizeHTML = _require5.sanitizeHTML,
  omitUnnecessaryTags = _require5.omitUnnecessaryTags,
  cleanBody = _require5.cleanBody,
  bodyHTML = _require5.bodyHTML,
  bodyText = _require5.bodyText;
var _require6 = require('./meta'),
  scrapeMetadata = _require6.scrapeMetadata;
...
var extract = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(link, proxy) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = new URL(link);
          _context.next = 3;
          return fetchAPI(url.href, proxy);
        case 3:
          html = _context.sent;
          dom = load(sanitizeHTML(html), {
            withDomLvl1: true,
          ...
          doc = new JSDOM(dom.html(), {
            url: url.href
          });
          reader = new Readability(doc.window.document);
          res = reader.parse();
          body = cleanBody(load(res.content || '', {
            withDomLvl1: true,
            normalizeWhitespace: false,
            xmlMode: false,
            decodeEntities: false
