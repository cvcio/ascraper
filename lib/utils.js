				...
				switch (_context.prev = _context.next) {
					...
					case 5:
						...
						req = {
							...
							timeout: 60000,
							httpAgent: new _http2.default.Agent({ keepAlive: true, rejectUnauthorized: false }),
							httpsAgent: new _https2.default.Agent({ keepAlive: true, rejectUnauthorized: false })
						};
