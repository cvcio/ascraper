...
var fetchHTML = function () {
	var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(link, proxy) {
		var url, httpAgent, httpsAgent, userAgent, html;
		return regeneratorRuntime.wrap(function _callee$(_context) {
			while (1) {
				switch (_context.prev = _context.next) {
					...
					case 5:
						httpAgent = proxy ? new _socksProxyAgent.SocksProxyAgent('socks://localhost:9201') : new _nodeHttp.http.Agent({ keepAlive: true });
						httpsAgent = proxy ? new _socksProxyAgent.SocksProxyAgent('socks://localhost:9201') : new _nodeHttps.https.Agent({ keepAlive: true });
						_context.prev = 7;
					...
					case 20:
						...
						return _context.abrupt('return', _context.t0.response.status);
