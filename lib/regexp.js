...
var REGEXP = {
  ...
  unlikelyCandidates: /aside|iframe|link|noscript|script|style|banner|breadcrumbs|combx|comment|community|cover-wrap|disqus|extra|foot|gdpr|header|legends|menu|related|remark|replies|rss|shoutbox|sidebar|skyscraper|social|sponsor|supplemental|ad-break|agegate|pagination|pager|popup|yom-remote|caption|category/i,
  ...
  hasContent: /\S$/,
  trimRe: /^\s+|\s+$/g,
  whiteBodyElems: /^a|blockquote|div|^ol|^p|^pre|table|ul|^li|h1|h2|h3|h4|span|strong|^b|^br|^i|^em|html|body/g,
